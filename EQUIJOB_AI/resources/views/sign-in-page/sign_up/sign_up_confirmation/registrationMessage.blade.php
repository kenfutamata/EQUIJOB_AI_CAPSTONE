...
<body>
    ...
    <div class="popup-component flex justify-center items-center min-h-screen px-4">
        <div class="w-full max-w-md bg-white shadow-lg rounded-lg p-6 mx-auto text-center">
            ...
            <div class="mt-12">
                <h3 class="text-gray-800 text-2xl font-bold">Sent!</h3>
                <p class="text-sm text-gray-600 mt-3">Please wait for the email confirmation for your approval of your account</p>
                <br>
                <a
