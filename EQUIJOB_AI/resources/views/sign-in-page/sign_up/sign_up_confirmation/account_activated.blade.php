...
<body>
    ...
    <div class="popup-component flex justify-center items-center min-h-screen px-4">
        <div class="w-full max-w-md bg-white shadow-lg rounded-lg p-6 mx-auto text-center">
            ...
            <div class="mt-12">
                <h3 class="text-gray-800 text-2xl font-bold">Account Activated!</h3>
                <p class="text-sm text-gray-600 mt-3">Please Click the Login Button below to direct you to the Sign-In Page</p>
                <br>
                <a
                    href="{{route('sign-in')}}" class="px-10 py-2.5 mt-10 w-full rounded-md text-white text-sm font-semibold tracking-wide border-none outline-none bg-blue-500 hover:bg-blue-600">
                    OK
                </a>
            </div>
        </div>
