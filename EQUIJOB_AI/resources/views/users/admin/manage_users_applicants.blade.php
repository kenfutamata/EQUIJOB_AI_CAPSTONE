        ...
        <div class="bg-white rounded-2xl shadow-xl w-full max-w-md max-h-[90vh] overflow-y-auto p-6 space-y-6">
            ...
            <div class="space-y-4">
                ...
                <div>
                    ...
                    <input id="modal_address" type="text" class="w-full border rounded-md px-4 py-2 text-sm" />
                </div>
                <div>
                ...
                <div>
                    ...
                    <input id="modal_date_of_birth" type="text" class="w-full border rounded-md px-4 py-2 text-sm" />
                </div>
                <div>
                ...
                <div>
                    ...
                    <img id="modal_pwd_card" src="" alt="PWD Card" class="w-[100px] h-[100px] object-cover" />
                </div>
                <div>
                    <label class="block text-sm text-gray-600 mb-1">Disability Type</label>
                    <input id="type_of_disability" type="text" class="w-full border rounded-md px-4 py-2 text-sm" />
                </div>
                <div>
