    ...
    <body class="bg-white text-black">
                    ...
                    <tbody class="divide-y divide-gray-200">
                        ...
                        <tr class="hover:bg-gray-50">
                            ...
                            <td class="px-4 py-3">
                                ...
                                @endphp
                                <img src="{{ $logoUrl }}" alt="Company Logo" class="w-[30px] h-[30px] object-cover rounded mx-auto">
                                @else
                                No Logo
                                @endif
                            </td>
                            ...
                            <td class="px-4 py-3 space-y-1">
                                ...
                                @endif
                                <button onclick="openDeleteModal('{{route('admin-manage-user-job-providers-delete', $user->id)}}')" class="bg-red-500 text-white px-2 py-1 rounded">Delete</button>
        ...
        <div id="viewProfileModal" class="fixed inset-0 bg-black bg-opacity-40 flex items-center justify-center z-50 hidden">
            <div class="bg-white rounded-2xl shadow-xl w-full max-w-md max-h-[90vh] overflow-y-auto p-6 space-y-6">
                ...
                <div class="space-y-4">
                    ...
                    <div id="modal_businessPermit_container"></div>
        ...
        <div id="DeleteRoleModal" class="fixed inset-0 bg-black bg-opacity-40 flex items-center justify-center z-50 hidden">
            <div class="bg-white rounded-2xl shadow-xl w-full max-w-md p-6 space-y-6">
                <div class="flex justify-between items-center">
                    <h3 class="text-xl font-semibold">Delete Job Provider Account?</h3>
                    <button onclick="closeDeleteModal()" class="text-gray-400 hover:text-gray-600 text-2xl">×</button>
                </div>
                <form id="deleteJobProviderAccount" method="POST" action="">
                    @csrf
                    @method('DELETE')
