...
<head>
  ...
  <title>Delete Job Provider Account Details</title>
  <style>
    body,
    table,
    td,
        ...
        <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px; background-color: #ffffff;">
          ...
          <tr>
            <td align="left" style="padding: 0 30px 20px 30px; font-family: Arial, sans-serif; font-size: 16px; line-height: 24px; color: #333333;">
              <p style="margin: 0;">Thank you for Signing up with EQUIJOB. After weighing all the infomation you presented. Please be informed that your account for Job Provider will be 
