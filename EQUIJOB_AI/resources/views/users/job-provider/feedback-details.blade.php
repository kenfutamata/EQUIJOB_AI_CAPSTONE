            ...
            <div class="space-y-6">
                ...
                <div>
                    <p class="text-gray-700">
                         We would like to request your insights about your experience during your Job as {{$maildata['position']}} at {{$maildata['companyName']}}. 
                        <br>
                        Kindly check your application feedback page to provide your feedback.
                        <br>
                        We hope and value a positive response from you
                        <br>
                        Thank you.
                    </p>
                </div>
