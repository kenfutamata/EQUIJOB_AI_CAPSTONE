<div class="w-[234px] min-h-screen bg-[#B3C7F7] flex flex-col justify-between border-r border-black p-2">
  <div>
    ...
    <nav class="flex flex-col gap-2 px-2">
      ...
      <a class="flex items-center gap-3 px-2 py-2 rounded bg-[#B3C7F7] text-[#262626] font-semibold hover:bg-[#a4b8e0]" href="{{route('job-provider-manage-job-applications')}}">
      ...
      <a class="flex items-center gap-3 px-2 py-2 rounded bg-[#B3C7F7] text-[#262626] font-semibold hover:bg-[#a4b8e0]" href="{{route('job-provider-generate-report')}}">
