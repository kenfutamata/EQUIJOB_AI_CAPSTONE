...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'auth.guards.job_provider.driver' => 'string',
            'auth.guards.job_provider.provider' => 'string',
            'auth.guards.admin.driver' => 'string',
            'auth.guards.admin.provider' => 'string',
            'auth.guards.api' => 'array',
            ...
            'auth.providers.job_providers.driver' => 'string',
            'auth.providers.job_providers.model' => 'string',
            ...
            'filesystems.links.C:\Users\kenfu\OneDrive\Documents\College\capstone\system1\EQUIJOB_AI_CAPSTONE\EQUIJOB_AI\public\storage' => 'string',
            ...
            'services.google_gemini.key' => 'string',
            'services.google_gemini.url' => 'string',
            'services.google_gemini.model' => 'string',
            ...
            'session.web.driver' => 'string',
            'session.web.lifetime' => 'integer',
            'session.web.expire_on_close' => 'boolean',
            'session.web.encrypt' => 'boolean',
...
'auth.guards.applicant.driver','auth.guards.applicant.provider','auth.guards.job_provider.driver','auth.guards.job_provider.provider','auth.guards.admin.driver',
'auth.guards.admin.provider','auth.guards.api','auth.providers.users.driver','auth.providers.users.model','auth.providers.applicants.driver',
'auth.providers.applicants.model','auth.providers.job_providers.driver','auth.providers.job_providers.model','auth.providers.admins.driver','auth.providers.admins.model',
...
'filesystems.links.C:\\Users\\kenfu\\OneDrive\\Documents\\College\\capstone\\system1\\EQUIJOB_AI_CAPSTONE\\EQUIJOB_AI\\public\\storage','logging.default','logging.deprecations.channel','logging.deprecations.trace','logging.channels.stack.driver',
...
'services.slack.notifications.channel','services.openai.key','services.google_gemini.key','services.google_gemini.url','services.google_gemini.model',
...
'session.partitioned','session.web.driver','session.web.lifetime','session.web.expire_on_close','session.web.encrypt',
...
'web','api',);
        registerArgumentsSet('routes', 'landing-page','sign-in','login',
'sign-up-applicant','sign-up-job-provider','sign-up-applicant-register','sign-up-job-provider-register','email-confirmation',
'job-provider-dashboard','job-provider-logout','job-provider-profile','job-provider-job-posting','job-provider-job-posting-store',
'job-provider-job-posting-delete','job-provider-job-posting-show','notification-delete','applicant-dashboard','applicant-logout',
'applicant-profile','applicant-profile-update','applicant-resume-builder','applicant-resume-builder-store','applicant-resume-view-and-download',
'applicant-resume-download','admin-dashboard','admin-logout','admin-manage-user-applicants','admin-manage-user-applicants-accept',
'admin-manage-user-Job-Providers-accept','admin-manage-user-job-providers','admin-manage-user-job-providers-delete','admin-manage-user-applicants-delete','admin-manage-job-posting',
'admin-manage-job-posting-for-posting','admin-manage-job-posting-disapproved','Admin-job-posting-show','storage.local',);
        registerArgumentsSet('views', 
'components.admin-sidebar','components.applicant-sidebar','components.job-provider-sidebar','components.landing-page-navbar','components.topbar',
'landing_page','layouts.app','sign-in-page.sign_in','sign-in-page.sign_up.sign_up_applicant','sign-in-page.sign_up.sign_up_confirmation.email_confirmation',
'sign-in-page.sign_up.sign_up_confirmation.registrationMessage','sign-in-page.sign_up.sign_up_job_provider','users.admin.admin_dashboard','users.admin.admin_manage_job_posting','users.admin.manage_user_jobprovider',
'users.admin.manage_users_applicants','users.applicant.applicant_dashboard','users.applicant.applicant_profile','users.applicant.resume-view','users.applicant.resume_builder',
'users.job-provider.job_application','users.job-provider.job_posting','users.job-provider.job_provider_dashboard','users.job-provider.job_provider_profile','laravel-exceptions-renderer::components.card',
...
'DB_CONNECTION','DB_URL','DB_PORT','DB_DATABASE','DB_USERNAME',
'DB_PASSWORD','DB_SCHEMA','SESSION_DRIVER','SESSION_LIFETIME','SESSION_ENCRYPT',
...
'GOOGLE_GEMINI_API_KEY','GOOGLE_GEMINI_ENDPOINT','GOOGLE_GEMINI_MODEL',);
